...
{    
    ...
    {    
        ...
        glColor3ub((GLubyte)255,(GLubyte)0,(GLubyte)0);//颜色设置为白色    
        glVertex3f(50.0f,50.0f,50.0f);    
        glColor3ub((GLubyte)255,(GLubyte)0,(GLubyte)0);//颜色设置为黄色    
        glVertex3f(50.0f,-50.0f,50.0f);    
        ...
        glColor3f(0.0f,0.0f,1.0f);//颜色设置为青色    
        glVertex3f(50.0f,50.0f,-50.0f);    
    
        glColor3f(0.0f,0.0f,1.0f);//颜色设置为绿色    
        glVertex3f(50.0f,-50.0f,-50.0f);    
    
        glColor3f(0.0f,0.0f,1.0f);//颜色设置为黑色    
        glVertex3f(-50.0f,-50.0f,-50.0f);    
        ...
        glColor3f(1.0f,0.0f,0.0f);//颜色设置为绿色    
        glVertex3f(50.0f,-50.0f,-50.0f);    
    
        glColor3f(1.0f,0.0f,0.0f);//颜色设置为黄色    
        glVertex3f(50.0f,-50.0f,50.0f);    
    
        glColor3f(1.0f,0.0f,0.0f);//颜色设置为红色    
        glVertex3f(-50.0f,-50.0f,50.0f);    
    
        glColor3f(1.0f,0.0f,0.0f);//颜色设置为黑色    
        glVertex3f(-50.0f,-50.0f,-50.0f);    
        glEnd();    
    
        glBegin(GL_POLYGON); //左表面    
        glColor3f(0.0f,1.0f,0.0f);//颜色设置为白色    
        glVertex3f(50.0f,50.0f,50.0f);    
    
        glColor3f(0.0f,1.0f,0.0f);//颜色设置为青色    
        glVertex3f(50.0f,50.0f,-50.0f);    
    
        glColor3f(0.0f,1.0f,0.0f);//颜色设置为绿色    
        glVertex3f(50.0f,-50.0f,-50.0f);    
    
        glColor3f(0.0f,1.0f,0.0f);//颜色设置为黄色    
        glVertex3f(50.0f,-50.0f,50.0f);    
        glEnd();    
    
        glBegin(GL_POLYGON); //右表面    
        glColor3f(0.0f,0.0f,0.0f);//颜色设置为品红色    
        glVertex3f(-50.0f,50.0f,50.0f);    
    
        glColor3f(0.0f,0.0f,0.0f);//颜色设置为蓝色    
        glVertex3f(-50.0f,50.0f,-50.0f);    
    
        glColor3f(0.0f,0.0f,0.0f);//颜色设置为黑色    
        glVertex3f(-50.0f,-50.0f,-50.0f);    
    
        glColor3f(0.0f,0.0f,0.0f);//颜色设置为红色    
        glVertex3f(-50.0f,-50.0f,50.0f);    
        glEnd();    
    }    
    glPopMatrix();    
